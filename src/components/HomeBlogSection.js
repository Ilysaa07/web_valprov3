...
import { ArrowRight, Calendar, Newspaper, Clock, User } from 'lucide-react';
...
export default async function HomeBlogSection() {
  ...
  // Pisahkan Post Pertama (Featured) dan Sisanya
  const [featuredPost, ...sidePosts] = latestPosts;

  return (
    <section className="py-24 bg-stone-50/50 relative overflow-hidden border-t border-stone-200">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Link 
            href="/blog" 
            className="group flex items-center gap-2 px-6 py-3 bg-white border border-stone-200 rounded-full text-stone-600 font-bold text-sm hover:border-blue-200 hover:text-[#1e40af] transition-all shadow-sm hover:shadow-lg hover:shadow-blue-900/5"
          >
            Lihat Semua Artikel 
        ...
        {/* --- UNIQUE LAYOUT: 1 BIG LEFT, 2 STACKED RIGHT --- */}
