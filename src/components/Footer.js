          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
             ...
             <div className="bg-stone-900/50 border border-stone-800 rounded-2xl p-5 flex items-center justify-between hover:border-stone-700 transition-colors">
                ...
                <div className="flex gap-2">
                   ...
                   <a href="https://wa.me/6289518530306" className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#1e40af] text-white hover:bg-[#3b82f6] shadow-lg shadow-blue-900/20 transition-colors">
                      {/* Icon WA Putih */}
